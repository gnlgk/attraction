...
const SearchPage = () => {
    ...
    const loadMoreVideos = async () => {
        if (nextPageToken) {
            const nextVideo = await fetch(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=48&type=video&q=${searchID}&order=date&maxResults=48&pageToken=${nextPageToken}&key=${process.env.REACT_APP_YOUTUBE_API_KEY}`)
